...
namespace JiraApiOpenSourseLibrary.JiraRestClient
{
    public interface IJiraClient<TIssueFields> where TIssueFields : IssueFields, new()
    {
        ...
        IEnumerable<Issue<TIssueFields>> EnumerateIssuesByQuery(String jqlQuery, String[] fields, Int64 startIndex);
        ...
        /// <summary>Returns all changes</summary>
        List<History> GetChangelog(IssueRef issue);
        ...
        Comment CreateComment(Issue issue, String comment, Visibility visibility);
